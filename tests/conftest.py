...
def fixture_return_API() -> list:
    ...
    """
    return [
        {'id': '128754739', 'premium': False, 'name': 'Python Developer / Backend (парсеры)', 'department': None,
         ...
         'salary_range': {'from': 60000, 'to': 160000, 'currency': 'RUR', 'gross': False,
                          'mode': {'id': 'MONTH', 'name': 'За\xa0месяц'}, 'frequency': None},
         'type': {'id': 'open', 'name': 'Открытая'},
         'address': {'city': 'Екатеринбург', 'street': 'Восточная улица', 'building': '7Г', 'lat': 56.833664,
                     'lng': 60.635752, 'description': None, 'raw': 'Екатеринбург, Восточная улица, 7Г',
                     'metro': None, 'metro_stations': [], 'id': '12818458'},
         'response_url': None, 'sort_point_distance': None, 'published_at': '2025-12-15T15:01:05+0300',
         'created_at': '2025-12-15T15:01:05+0300', 'archived': False,
         ...
         'alternate_url': 'https://hh.ru/vacancy/128754739', 'relations': [],
         'employer': {'id': '4306244', 'name': 'VICTORY group', 'url': 'https://api.hh.ru/employers/4306244',
                      'alternate_url': 'https://hh.ru/employer/4306244',
                      'logo_urls': {'original': 'https://img.hhcdn.ru/employer-logo-original/1462732.png',
                                    '90': 'https://img.hhcdn.ru/employer-logo/7470538.png',
                                    '240': 'https://img.hhcdn.ru/employer-logo/7470539.png'},
                      'vacancies_url': 'https://api.hh.ru/vacancies?employer_id=4306244', 'country_id': 1,
                      'accredited_it_employer': True, 'trusted': True},
         'snippet': {'requirement': 'Опыт работы с парсерами на <highlighttext>Python</highlighttext> от 1 года. '
                                    'Знание Playwright, selenium, Httpx, requests и подобные. Rabbit / redis '
                                    'приветствуются. ', 'responsibility': 'Разработка Backend микросервисов и '
